...
class Pemesanan extends Model
{
    ...
    protected $fillable = ['id_track','id_cust','id_outlet','jenis_layanan','tipe_pemesanan','no_order','tanggal_masuk','tanggal_selesai','berat_cucian','jumlah_item','total_harga', 'catatan_khusus', 'status_proses', 'status_bayar'];
